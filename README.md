...
**[MathMagician]** is a project that aims to build a dynamic calculator using the full features of React and Redux
...
```shell
cd my-folder
git clone https://github.com/Samuelwanza/mathmagicians.git
